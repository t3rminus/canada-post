...
declare class CanadaPostClient {
    ...
    constructor(userId: any, password: any, customer: any, lang: any, useTestEndpoint: any);
    endpoint: string;
    auth: any;
    customer: any;
    lang: any;
    _request(call: any, params: any, contentType: any, path?: any, method?: string): Promise<any>;
    _rawRequest(method: any, url: any, contentType: any, body: any): Promise<any>;
    discoverServices(originPostalCode: any, destinationCountry: any, destinationPostalCode: any): Promise<any>;
    ...
    refundNonContractShipment(id: any, email: any): Promise<{
        serviceTicketId: any;
